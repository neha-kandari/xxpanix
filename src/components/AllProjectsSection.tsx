...
const projects = [
  {
    ...
    description: "A professional website for a corporate business featuring service showcases, team profiles, and client testimonials.",
    image: "/1.png",
    category: "Web Development",
    technologies: ["HTML", "CSS", "JavaScript", "Bootstrap"],
    liveUrl: "https://xpanix.github.io/TechAhead/",
    featured: true,
  },
  {
    id: 2,
    title: "Portfolio Website",
    description: "A creative portfolio website showcasing projects, skills, and professional achievements with modern design elements.",
    image: "/3.png", 
    category: "Web Development",
    technologies: ["HTML", "CSS", "JavaScript", "GSAP"],
    liveUrl: "https://xpanix.github.io/Portfolio/",
    featured: true,
  },
  {
    id: 3,
    title: "Fast Food Website",
    description: "A vibrant fast food restaurant website with menu displays, online ordering capabilities, and location information.",
    image: "/4.png",
    category: "Web Development", 
    technologies: ["HTML", "CSS", "JavaScript", "Bootstrap"],
    liveUrl: "https://xpanix.github.io/Foodie-Hub/",
    featured: true,
  },
  {
    id: 4,
    title: "Web Design Prototype",
    description: "An innovative web design prototype created in Figma, demonstrating modern UI principles and user experience design.",
    image: "/5.png",
    category: "UI/UX Design",
    technologies: ["Figma"],
    liveUrl: "https://www.figma.com/proto/Y4u3Y6VhELgxUBfVE6gNzJ/TechGadget---Technology-Website--Community-?page-id=0%3A1&node-id=1-2&p=f&viewport=489%2C487%2C0.13&t=2pHDNP3x2IG1b12r-1&scaling=min-zoom&content-scaling=fixed",
    featured: true,
  },
  {
    id: 5,
