...
export default function StatsCounter() {
  ...
  const count0 = useCountUp(statsMemo[0].value, 1200);
  const count1 = useCountUp(statsMemo[1].value, 1400);
  const count2 = useCountUp(statsMemo[2].value, 1600);
  const count3 = useCountUp(statsMemo[3].value, 1800);
